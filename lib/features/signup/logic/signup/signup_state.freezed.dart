...
extension SignupStatePatterns<T> on SignupState<T> {
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case _Failure() when failure != null:
        return failure(_that.errorMassage);
      case _:
        return orElse();
    }
  }
...
class _Failure<T> implements SignupState<T> {
  const _Failure(this.errorMassage);
  ...
  @override
  String toString() {
    return 'SignupState<$T>.failure(errorMassage: $errorMassage)';
  }
}
